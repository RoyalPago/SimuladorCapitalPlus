class Tabelas {
    ...
    obterTaxa(bandeira, parcelas) {
        const taxas = {       
        "Tabela 22": {
        visamaster: [0.93000,0.91780,0.90090,0.88300,0.87210,0.85160,0.84685,0.84091,0.83477,0.82873,0.82873,0.81665],
        elohiper: [0.93000,0.90960,0.89270,0.87480,0.86390,0.84348,0.83893,0.83289,0.82675,0.82071,0.81467,0.80863],
        amex: [0.92260,0.91780,0.90090,0.88300,0.87210,0.85160,0.84685,0.84091,0.83477,0.82873,0.82873,0.81665],
        debito: [0.95650]
        },

       "Tabela 24": { 

        visamaster: [0.93000,0.91780,0.90090,0.88250,0.86710,0.83745,0.83282,0.82681,0.82070,0.81469,0.80869,0.80268],
        elohiper: [0.90981,0.90960,0.89270,0.87430,0.85890,0.82937,0.82484,0.81883,0.81272,0.80672,0.80071,0.79470],
        amex: [0.92260,0.91780,0.90090,0.88250,0.86710,0.83745,0.83282,0.82681,0.82070,0.81469,0.80869,0.80268],
        debito:[0.95650]
        },

        "Tabela 25": {
        visamaster: [0.92436,0.90367,0.88892,0.87318,0.85843,0.83532,0.83070,0.81980,0.81371,0.80771,0.80172,0.79573],
        elohiper: [0.92436,0.89555,0.88080,0.86506,0.85031,0.82727,0.82275,0.81675,0.80575,0.79976,0.79376,0.78777],
        amex: [0.91699,0.90367,0.88892,0.87318,0.85843,0.83532,0.83070,0.82471,0.81371,0.80771,0.80172,0.79573],
        debito:[0.95500]
        },

        "Tabela 26": {
        visamaster: [0.92436,0.89971,0.88496,0.87120,0.85348,0.82830,0.82467,0.81777,0.80772,0.80174,0.79576,0.78978],
        elohiper: [0.92436,0.89159,0.87684,0.86308,0.84536,0.82026,0.81673,0.80977,0.79978,0.79380,0.78782,0.78184],
        amex: [0.91699,0.89971,0.88496,0.87120,0.85348,0.82830,0.82467,0.81771,0.80772,0.80174,0.79576,0.78978],
        debito:[0.95500]
        },
        
        "Tabela 27": {
            visamaster: [0.91674,0.89911,0.87951,0.86680,0.84917,0.81985,0.81625,0.81034,0.80044,0.79453,0.79249,0.78657,0.77559,0.76491,0.75452,0.74441,0.73457,0.72498],

            elohiper: [0.91674,0.89103,0.87143,0.85872,0.84109,0.81189,0.80840,0.80248,0.79259,0.78667,0.78463,0.77872,0.77559,0.76491,0.75452,0.74441,0.73457,0.72498],
            
            amex: [0.90941,0.89911,0.87851,0.86680,0.84917,0.81984,0.81626,0.81034,0.80044,0.79453,0.79249,0.78657,0.77559,0.76491,0.75452,0.74441,0.73457,0.72498],
            debito: [0.94724]
        },

        "Tabela 28": {
        visamaster: [0.91476,0.89852,0.87852,0.86582,0.84917,0.81139,0.80688,0.80102,0.79123,0.78634,0.78336,0.77750],
        elohiper: [0.91476,0.88906,0.87044,0.85774,0.84109,0.80352,0.79910,0.79325,0.78346,0.77856,0.77558,0.76973],
        amex: [0.90743,0.90743,0.87852,0.86582,0.84917,0.81139,0.80688,0.80102,0.79123,0.78634,0.78336,0.77750],
        debito:[0.96443]
        },

        "Tabela 30": {
            visamaster: [0.91179,0.89320,0.87852,0.86188,0.84523,0.79914,0.79467,0.78888,0.78299,0.77719,0.77140,0.76560,0.75520,0.74507,0.73521,0.72561,0.71625,0.70713],
        
            elohiper: [0.91179,0.88512,0.87044,0.85380,0.83715,0.79135,0.78698,0.78119,0.77530,0.76950,0.76371,0.75791,0.75520,0.74507,0.73521,0.72561,0.71625,0.70713],
        
            amex: [0.90446,0.89320,0.87852,0.86188,0.84523,0.79914,0.79468,0.78888,0.78299,0.77720,0.77140,0.76561,0.75520,0.74507,0.73521,0.72561,0.71625,0.70713],
            debito: [ 0.94037]
        },

        "Tabela 32": {
        visamaster: [0.90981,0.89221,0.87754,0.86089,0.84424,0.78979,0.78537,0.77964,0.77381,0.76807,0.76234,0.75661],
        elohiper: [0.90981,0.88414,0.86946,0.85281,0.83617,0.78208,0.77776,0.77202,0.76619,0.76046,0.75475,0.74899],
        amex: [0.90248,0.89221,0.87754,0.86089,0.84424,0.78979,0.78537,0.77964,0.77381,0.76807,0.76234,0.75661],
        debito: [ 0.93744]
        },
...
function calcularDesconto() {
    ...
    if (['Tabela 27', 'Tabela 30', 'Tabela 34'].includes(tabela)) {
        ...
        if (parcelas > 12) {
            resultadoDiv.innerHTML = '<p style="color:red;">O número máximo de parcelas para esta tabela é 12.</p>';
            return;
        }
    }
    ...
    try {
        ...
        const comissaoVendedor = calcularComissoes(desconto.valorcomdesconto, parcelas, tabela);
    ...
    ultimodesconto = {
        ...
        resultadoDiv.innerHTML = `
            <h3>Resultado:</h3>
            <p><strong>Valor de entrada:</strong> R$${desconto.valor.toFixed(2)}</p>
            <p><strong>Valor com o Desconto:</strong> R$${desconto.valorcomdesconto.toFixed(2)}</p>
            <p><strong>Parcelas:</strong> ${desconto.parcelas}x de R$${desconto.valorParcelas.toFixed(2)}</p>
    ...
    async function salvarDescontos(desconto) {
        const response = await fetch('https://simulador-royal.onrender.com//salvar-desconto', {
            method: 'POST',
...
function gerarPDF() {
    ...
    doc.text(`Valor com desconto: R$ ${ultimodesconto.valorcomdesconto.toFixed(2)}`, 20, 100);
    doc.text(`Forma de Pagamento: ${ultimodesconto.parcelas}x de R$ ${ultimodesconto.valorParcelas.toFixed(2)}`, 20, 107);
